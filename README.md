...
<p align="center">
  <img src="assets/readme/course-select.png" alt="코스 선택" width="30%">
  <img src="assets/readme/mission-detail.png" alt="미션 상세" width="30%">
  <img src="assets/readme/ebook-complete.png" alt="동화책 완성" width="30%">
</p>
...
| **사진 검증** | <img src="assets/readme/camera-verification.png" width="180"> | CameraX · EXIF · 로컬 ONNX 분류 |
...
| **미션 카메라** | CameraX 촬영 → EXIF/GPS → ONNX → 매칭 → 업로드 | `HeritageClassifier`, `HeritageMissionMatcher` 직접 구현 |
